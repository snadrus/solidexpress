...
4. **Drag the solid itself** (after a short move past the click slop) to move it on the horizontal plane. Tiny clicks still refine selection instead of nudging. While dragging you see the **old** and **new** center marks plus an editable **Δ** row. Type **ΔZ** to hop off-plane.
