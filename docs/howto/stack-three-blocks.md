...
Goal: three 50 mm cubes sitting on top of each other (total height 150 mm).
...
3. Repeat: **Box** → click the top of the second block. You now have three cubes: floors at `z = 0`, `50`, and `100`; overall top at `150`.
...
- Combined height ≈ 150 mm from the ground.
