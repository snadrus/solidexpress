...
Goal: three default cubes (10 mm) sitting on top of each other (total height 30 mm).
...
3. Repeat: **Box** → click the top of the second block. You now have three cubes: floors at `z = 0`, `10`, and `20`; overall top at `30`.
...
- Combined height ≈ 30 mm from the ground.
