...
const TABLE: Array[Dictionary] = [
	...
	{"keys": "ΔZ grip (above body)", "context": "Model", "desc": "Drag to leave / approach the ground plane (tap Z mid-drag also locks vertical)"},
	{"keys": "X / Y / Z (while moving)", "context": "Model", "desc": "Lock the body move to that axis (tap again to free; highlighted axis line)"},
	{"keys": "Drag stretch arrow", "context": "Model", "desc": "Stretch a primitive face outward; Enter refines Δ"},
